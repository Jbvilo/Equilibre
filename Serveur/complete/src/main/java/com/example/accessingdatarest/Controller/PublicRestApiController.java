    ...
    private void sendmail(String mail) throws AddressException, MessagingException, IOException {
        ...
        Session session = Session.getInstance(props, new javax.mail.Authenticator() {
            protected PasswordAuthentication getPasswordAuthentication() {
                // return new PasswordAuthentication("equilibretest@hotmail.com",
                // "equilibre9494");
        ...
        messageBodyPart.setText(
                "Cliquez sur ce lien pour créer un nouveau mot de passe http://localhost:4200/change-password/:80806");
